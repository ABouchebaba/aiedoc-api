...
router.get("/", (req, res) => {
  res.send("Welcome to Aiedoc API");
});

router.get("/stats/users/week", async (req, res) => {
  const days = 7;
...
router.get("/stats/users/month", async (req, res) => {
  const days = 365;
  const date = new Date(new Date() - days * 60 * 60 * 24 * 1000);
...
router.get("/stats/interventions/total", async (req, res) => {
...
router.get("/stats/interventions/month", async (req, res) => {
  const days = 365;
  const date = new Date(new Date() - days * 60 * 60 * 24 * 1000);
...
router.get("/stats/commands/total", async (req, res) => {
